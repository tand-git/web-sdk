...
### 사용자 속성 설정
사용자 속성(아이디, 등급, 성별, 출생년도, 보유 포인트)를 설정합니다.  

> 사용자 속성(성별, 출생년도, 기타 등) 분석을 위해 로그인 및 속성이 갱신되는 시점에 개별로 설정

> 사용자ID는 사용자가 직접 로그인 하였을 때 설정합니다
```js
/* 사용자가 직접 로그인 성공하였을때 */
// 사용자 아이디 설정
